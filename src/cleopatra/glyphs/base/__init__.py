...
`FuncAnimation` save/embed helpers), `hillshade` (shaded-relief math). These
are the machinery the concrete glyphs in `gridded`, `primitives`, and `stats`
build on, not chart types themselves.
"""
