...
The `cleopatra.glyphs.animation` module exposes cleopatra's animation **save / inline-embed**
...
from cleopatra.glyphs.animation import embed_gif, save_animation, to_gif
